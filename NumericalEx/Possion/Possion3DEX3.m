...
% 子区域网格剖分
FEMBaseType1='quadratic';
FEMBaseType2='linear';
% 下部区域
[P1,T1,Pb1,Tb1] = genMesh3D(ori1,a1,b1,c1,[],[],[],FEMBaseType1,xStep1,yStep1,zStep1);
% 上部区域
[P2,T2,Pb2,Tb2] = genMesh3D(ori2,a2,b2,c2,[],[],[],FEMBaseType2,xStep2,yStep2,zStep2);
viewMesh(P1,T1)
hold on
viewMesh(P2,T2)
% 参考单元信息计算
...
[phi1,Dphi1] = BaseFunOnRefGauss(order,FEMBaseType1);
[phi2,Dphi2] = BaseFunOnRefGauss(order,FEMBaseType2);
% 矩阵、载荷向量组装
% 下部区域
[Jacobi1,Jacobi_inv1,y1] = AffineToCuboid(pt,P1,T1,1);
A11 = AssembleFEMMatrix(1,Pb1,Tb1,[1,0,0],[1,0,0],phi1,Dphi1,Jacobi1,Jacobi_inv1,w);
A22 = AssembleFEMMatrix(1,Pb1,Tb1,[0,1,0],[0,1,0],phi1,Dphi1,Jacobi1,Jacobi_inv1,w);
A33 = AssembleFEMMatrix(1,Pb1,Tb1,[0,0,1],[0,0,1],phi1,Dphi1,Jacobi1,Jacobi_inv1,w);
K1 = A11+A22+A33;
F1 = AssembleFEMVector(f,Pb1,Tb1,phi1,Jacobi1,y1,w);
% 上部区域
[Jacobi2,Jacobi_inv2,y2] = AffineToCuboid(pt,P2,T2,1);
A11 = AssembleFEMMatrix(1,Pb2,Tb2,[1,0,0],[1,0,0],phi2,Dphi2,Jacobi2,Jacobi_inv2,w);
A22 = AssembleFEMMatrix(1,Pb2,Tb2,[0,1,0],[0,1,0],phi2,Dphi2,Jacobi2,Jacobi_inv2,w);
A33 = AssembleFEMMatrix(1,Pb2,Tb2,[0,0,1],[0,0,1],phi2,Dphi2,Jacobi2,Jacobi_inv2,w);
K2 = A11+A22+A33;
F2 = AssembleFEMVector(f,Pb2,Tb2,phi2,Jacobi2,y2,w);
K=blkdiag(K1,K2);
% 组装Lagrange乘子矩阵
MasterSiderInfo={interval1,FEMBaseType1,xStep1,yStep1,zStep1,Pb1,Tb1};
SlaveSiderInfo={interval2,FEMBaseType2,xStep2,yStep2,zStep2,Pb2,Tb2};
...
% 处理Dirichlet边界条件
Pb=[Pb1;Pb2];
boundary_index=find(Pb(:,1)==interval(1,1)|Pb(:,1)==interval(1,2)|...
